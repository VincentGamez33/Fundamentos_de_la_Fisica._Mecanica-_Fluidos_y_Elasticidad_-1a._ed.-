    ...
    \begin{demostracion}
        ...
        \begin{enumerate}[label=\textit{\roman*)}]
            ...
            \begin{align*}
                ...
                & = \lambda\veca + \mu\veca.
            \end{align*}
            Por lo tanto, queda demostrada la distributividad respecto a la suma de escalares. \QEDblack
        \end{enumerate}
    \end{demostracion}
\end{theorem}
...
\begin{theorem}{}{producto_interno_canonico}
    ...
    \begin{demostracion}
        Consideremos el producto interno de los vectores $\veca$ y $\vecb$, el cual, según la \ref{definition:producto_interno_geometrico}, está dado por la expresión
            ...
            \[ \veca \cdot \vecb = a_x b_x + a_y b_y + a_z b_z. \QEDblack\]
    \end{demostracion}
\end{theorem}
...
\begin{theorem}{}{propiedades_producto_cruz}
    ...
    \begin{demostracion}
        ...
        \begin{enumerate}[label=\textit{\roman*)}]
            ...
            \[ \vecb \times \veca = -(\veca \times \vecb). \QEDblack\]
        \end{enumerate}
    \end{demostracion}
\end{theorem}
